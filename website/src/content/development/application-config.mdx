...
The application config is the new recommended replacement of the previous `env.json` and `headers.json` files. Read the [release notes on how to migrate to the new config](https://docs.commercetools.com/custom-applications/releases/2020-07-16-introducing-a-new-and-simpler-application-config).
